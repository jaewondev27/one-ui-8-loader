...
```html
<script src="https://cdn.jsdelivr.net/gh/jaewondev27/one-ui-8-loader/one8-loader.js"></script>

<one8-loader size="1.5" speed="2.0"></one8-loader>

<script>
    const loader = document.querySelector('one8-loader');
